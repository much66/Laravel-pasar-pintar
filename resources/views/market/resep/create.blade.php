...
@section('container')
    ...
    <div class="col-lg-8">
        <form method="post" action="/resep/recipes" class="mb-5" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    is-invalid
                @enderror"
                    id="portion" name="portion" autofocus value="{{ old('portion') }}" required>
                @error('portion')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    is-invalid
                @enderror"
                    id="cooking_time" name="cooking_time" autofocus value="{{ old('cooking_time') }}" required>
                @error('cooking_time')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                is-invalid
                @enderror"
                    type="file" id="image" onchange="previewImage()" name="image">
                @error('image')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                @enderror
                <input type="hidden" value="{{ old('igredient') }}" id="igredient" name="igredient">
            ...
            <div class="mb-3">
                ...
                @enderror
                <input type="hidden" value="{{ old('description') }}" id="description" name="description">
            ...
            <button type="submit" class="btn btn-primary">Buat Resep</button>
        </form>
    </div>
